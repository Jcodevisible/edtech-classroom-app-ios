...
This repository contains the GEARS 2022 Lab project following the **Azure Communications Mobile Support** demo session. You should read the Lab Guide before trying to run this project as it contains it may contain useful information not presented in this README.
